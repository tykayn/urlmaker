...
<div class="aide">
	...
	images pour les poster sur son blog ou sur un forum par exemple. Vous pouvez lier vos images vers leur grande version,
	cependant il faut respecter le nommage du dossier contenant les grandes versions. Partie
	...
	d'analyse, vous validez et hop, vous n'avez plus qu'a copier coller les liens dans votre page de blog ou de site.
	<h3>Options.</h3>
	...
	<img src="doss_g.jpg" alt="dossiers"/> Une autre possibilité consiste à mettre les petites versions des images dans un
	sous dossier nommé <strong>thumb</strong> comme apperçu en Anglais.<br/> <img src="doss_t.jpg" alt="dossiers"/> Dans
	tous les cas, les deux versions des images doivent avoir le même nom de fichier pour que le lien fonctionne.

	En installant URL maker vous devrez avoir des dossiers bien rangés selon ce schéma:<br/> un dossier par année,
	contenant chacun un dossier par mois.<br/> C'est dans ces dossiers de mois que vous mettrez les images que vous voulez
	lier. par exemple<br/>
