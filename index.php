        ...
        <div id='main'>
            ...
            <form method='POST' cible='index.php'>
                ...
                <fieldset id='options'>
                    ...
                    <span class="choix">
                        <input type='checkbox' name='backreturn' value='1' <?php selected('backreturn', '1', 'checked'); ?>/> Retour à la ligne
                    </span>
                    <span class="choix">
...
if ($pasfound == 1) {
    $textes .="<span class='info'>Certains fichiers n'ont pas de deuxième version </span>";
}
if ($montrer_config == 0) {
    $config_infos = '';
}
...
if ($dir_unfound == 1) {
    $msg = "<span class='info'>harrrrrrr le dossier est fucké. URL maker vous propose le dossier suivant</span>";
}
